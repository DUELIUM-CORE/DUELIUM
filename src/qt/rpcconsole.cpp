                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDLPathCustom = GetArg("-zDLbackuppath", "");
    ...
    if(!strzDLPathCustom.empty()) {
        ui->wallet_customzDLbackuppath->setText(QString::fromStdString(strzDLPathCustom));
        ui->wallet_customzDLbackuppath_label->setVisible(true);
        ui->wallet_customzDLbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DUELIUM RPC console.") + "<br>" +
