...
/** Utility functions used by the DUELIUM Qt UI.
 */
namespace GUIUtil
{
...
// Render DUELIUM addresses in monospace font
...
// Parse "DUELIUM:" URI into recipient object, return true on successful parsing
