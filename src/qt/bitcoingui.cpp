                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DUELIUM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DUELIUM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and DUELIUM: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DUELIUM Core"), this);
    aboutAction->setStatusTip(tr("Show information about DUELIUM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DUELIUM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DUELIUM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DUELIUM addresses"));
    ...
    openAction->setStatusTip(tr("Open a DUELIUM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DUELIUM Core help message to get a list with possible DUELIUM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DUELIUM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DUELIUM network", "", count));
}
...
{
    QString strTitle = tr("DUELIUM Core"); // default title
