 ...
 */
    ...
    typeWidget->addItem(tr("Received DL from zDL"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDL"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDL));
