...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "DUELIUM server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DUELIUM features */
        {"DUELIUM", "masternode", &masternode, true, true, false},
        {"DUELIUM", "listmasternodes", &listmasternodes, true, true, false},
        {"DUELIUM", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"DUELIUM", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"DUELIUM", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"DUELIUM", "getmasternodecount", &getmasternodecount, true, true, false},
        {"DUELIUM", "masternodeconnect", &masternodeconnect, true, true, false},
        {"DUELIUM", "masternodecurrent", &masternodecurrent, true, true, false},
        {"DUELIUM", "masternodedebug", &masternodedebug, true, true, false},
        {"DUELIUM", "startmasternode", &startmasternode, true, true, false},
        {"DUELIUM", "createmasternodekey", &createmasternodekey, true, true, false},
        {"DUELIUM", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"DUELIUM", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"DUELIUM", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"DUELIUM", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"DUELIUM", "getmasternodescores", &getmasternodescores, true, true, false},
        {"DUELIUM", "mnbudget", &mnbudget, true, true, false},
        {"DUELIUM", "preparebudget", &preparebudget, true, true, false},
        {"DUELIUM", "submitbudget", &submitbudget, true, true, false},
        {"DUELIUM", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"DUELIUM", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"DUELIUM", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"DUELIUM", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"DUELIUM", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"DUELIUM", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"DUELIUM", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"DUELIUM", "checkbudgets", &checkbudgets, true, true, false},
        {"DUELIUM", "mnsync", &mnsync, true, true, false},
        {"DUELIUM", "spork", &spork, true, true, false},
        {"DUELIUM", "getpoolinfo", &getpoolinfo, true, true, false},
        {"DUELIUM", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzDLseed", &getzDLseed, false, false, true},
        {"zerocoin", "setzDLseed", &setzDLseed, false, false, true}
...
{
    return "> DUELIUM-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9889/\n";
}
