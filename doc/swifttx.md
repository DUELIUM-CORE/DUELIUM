...
* WebSocket: [https://github.com/DUELIUM/insight-api-DUELIUM#web-socket-api](https://github.com/DUELIUM/insight-api-DUELIUM#web-socket-api) 
* API: [https://github.com/DUELIUM/insight-api-DUELIUM#swifttx-transactions](https://github.com/DUELIUM/insight-api-DUELIUM#swifttx-transactions) 
...
By default, the DUELIUM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DUELIUM Core daemon:
