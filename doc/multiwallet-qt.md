...
In order to support loading of multiple wallets in DUELIUM-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is DUELIUM.cpp.
...
Changes to DUELIUM.cpp
----------------------
DUELIUM.cpp is the entry point into DUELIUM-qt, and as such, will require some minor modifications to provide hooks for
