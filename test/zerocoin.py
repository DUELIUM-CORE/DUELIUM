...
#   c) node1 mines 32 blocks, so now node 0 has 60001DL, node 1 has 4250DL, node2 has none.
#   d) node0 sends 601 DL to node2, in two transactions (301 DL, then 300 DL).
